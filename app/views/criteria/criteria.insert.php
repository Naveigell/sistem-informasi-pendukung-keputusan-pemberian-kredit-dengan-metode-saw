                        ...
                        <form action="/criteria/create" method="post" class="needs-validation" novalidate="">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control" id="name" placeholder="Masukkan nama kriteria ...">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="weight" type="number" class="form-control" id="weight" placeholder="Masukkan bobot ...">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
