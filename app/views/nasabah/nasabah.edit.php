                        ...
                        <form action="<?= BASE_PATH; ?>/nasabah/update" method="post" class="needs-validation" novalidate="">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input value="<?= date("Y-m-d", strtotime($nasabah['periode'])); ?>" name="periode" type="date" class="form-control <?= flashHas('error-periode') ? 'is-invalid' : ''; ?>" id="periode" placeholder="Masukkan periode ...">
                                    <div class="invalid-feedback">
